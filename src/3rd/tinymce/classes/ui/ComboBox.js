...
define(function (require, exports, module) {
    ...
    return Widget.extend({
        ...
        renderHtml: function () {
            ...
            if (icon || text) {
                var inputFileStyle = 'position:absolute;top:0;right:0;bottom:0;font-size:1000em;opacity:0;' +
                    '-ms-filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=0);' +
                    'filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=0);';

                openBtnHtml = (
                    '<div id="' + id + '-open" class="' + prefix + 'btn ' + prefix + 'open" tabIndex="-1" role="button">' +
                    '<a class="mce-btn-inner" href="javascript:;" id="' + id + '-action' + (settings.type === 'filepicker' ? '-father' : '') + '" hidefocus="1" tabindex="-1" style="position:relative;overflow:hidden;">' +
                    (settings.type === 'filepicker' ? '<input  id="' + id + '-action" type="file" hidefocus="1" tabindex="-1" name="' + settings.uploadFileName + '" style="' + inputFileStyle + '">' : '') +
