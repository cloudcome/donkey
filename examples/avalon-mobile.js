/*==================================================
 ...
 avalon.modern.shim.js 1.5.5 built in 2015.11.11
...
//    return avalon
    ...
    window.Avalon = function (configs) {
        ...
        var id = $ele.id;
        $ele.setAttribute('ms-important', id);
        var source = avalon.mix({
            $id: id
        }, configs.data, configs.methods);
